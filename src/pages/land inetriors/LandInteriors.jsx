...
const LandInteriors = () => {
  ...
  const img1Width1 = 'sm:w-[40px] sm:h-[40px]  md:w-[68px] md:h-[73px] w-[30px] h-[30px] '
  const img1Width2 = 'sm:w-[50px] sm:h-[45px]  md:w-[72px] md:h-[72px] w-[35px] h-[35px] '
  const img1Width3 = 'sm:w-[42px] sm:h-[42px]  md:w-[62px] md:h-[62px] w-[30px] h-[30px] '
  // const textt = 'w-[50px]' 
  ...
  return (
    <div className='  md:mt-[10%] mt-[10%]'>
      ...
      <div className='relative sm:static   md:grid md:grid-cols-6 md:mt-[10%]   mt-[25%]'>
        ...
        <div className='absolute md:static z-10 h-[410px] w-[50%] text-center   bg-white bg-opacity-75  md:z-10 md:col-span-2 md:h-[700px] lg:h-[85%] font-popins md:text-center md:w-[140%] md:p-3 md:mt-[25%] '>
          ...
          <p className='text-[12px] mt-[3%] sm:text-[13px] sm:mt-[3%]  w-[80%] mx-auto  md:text-[14px] lg:text-[18px] font-[400] md:mt-[1%]  md:w-[300px] md:-ml-[-45px]  lg:w-[400px] lg:ml-[50px]' >Complete the designs with painting, flooring and other decor solutions</p>
          <p className='text-[14px] mt-[8%] sm:text-[20px] sm:mt-[3%]  md:text-[26px] lg:text-[36px] font-[600] md:mt-[20%] lg:mt-[8%] text-[#4B2A63]  md:w-[300px] md:-ml-[-45px] lg:w-[400px] lg:ml-[50px]'>Move-in</p>
          <p className='text-[12px] mt-[3%] sm:text-[13px] sm:mt-[3%]  w-[80%] mx-auto  md:text-[14px] lg:text-[18px] font-[400] md:mt-[1%]   md:w-[300px] md:-ml-[-45px]  lg:w-[400px] lg:ml-[50px]'>Move in with ease, with our hassle-free civil work and installation services.</p>
