    ...
    return (
        ...
        <div className={combinedClasses}>
            ...
            <div className='md:mt-10 '>
                ...
                <div className=''><img src={props.imagesr} alt="" className='' /></div>
                <div className=' lg:mt-[20px] flex justify-center  lg:ml-[-60px] lg:text-[18px] lg:font-[400] mt-[3px] text-[12px] text-center  w-[80px]  ml-[-22px] sm:text-[18px]  sm:w-[150px] md:w-[190px]  sm:ml-[-47px]  sm:mt-[13px]  md:text-center slg:mt-[13px]  md:text-[24px] '>{props.text}</div>
