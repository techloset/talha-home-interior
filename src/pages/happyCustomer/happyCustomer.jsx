...
const happyCustomer = () => {
    return (
        <div className=' sm:mx-8 lg:mx-0 mt-[10%]  lg:grid lg:mt-[7%] font-popinsmedium'>
            ...
            <div class=' sm:mx-8  lg:text-center lg:ml-[200px] slg:mx-[135px]'>
                <p className=' text-[18px]  sm:text-[36px] font-[500] lg:m-8'>Our Happy Customers</p>
                <p className=' lg:w-[755px] text-[12px] mt-[10px] lg:m-auto sm:text-start sm:text-[16px] slg:text-[18px] slg:w-[755px] sm:font-[400] '>Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam, purus sit amet
            ...
            <div className='realtive  z-0 lg:grid lg:grid-cols-12 lg:text-center lg:mt-[3%]' >
                ...
                {/* mobile background image */}
                    ...
                    <img src="/images/arrow.png" alt="" className='lg:hidden sm:hidden slg:block  absolute slg:mt-[16%] left-[12%] inline '/>
                    <img src="/images/arrow1.png" alt="" className=' lg:hidden sm:hidden  slg:block  absolute slg:mt-[16%] left-[86%]'/>
            ...
            <div className=' font-popinsmedium absolute w-[70%] sm:left-[15%] slg:w-[680px] slg:ml-[40px] lg:ml-auto   sm:mt-[-262px]  lg:static  z-10   bg-white sm:h-[250px] lg:w-[738px]   lg:h-[250px] lg:mt-[-205px] lg:mx-[28%]  lg:m-auto lg:text-center'>
                ...
                <p className=' lg:hidden p-5 sm:text-[20px]  w-[580px] mx-auto  text-[10px] font-[400]  text-center'>Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam, purus sit amet luctus venenatis,
