    ...
    return (
        <div className='  font-popinsmedium sm:mx-[20px]   '>
            ...
            >
                ...
                <div className=" sm:mt-[3%] lg:mt-auto sm:mx-auto  sm:w-[104%] slg:w-[80%]  grid xl:grid-cols-10 max-md:grid-cols-5 grid-rows-2 gap-2 xl:gap-2 max-h-[70vh] px-6 sm:px-10 md:px-16 ms:px-[148px] xl:px-16 w-full xl:w-[80.333%] mx-auto [&>img]:w-[400px]  [&>img]:h-full ">
            ...
            <p className= 'hidden slg:block  slg:ml-auto slg:w-[730px] sm:ml-[40px] sm:w-[730px] slg:mt-[38px]  text-[14px] sm:text-[22px] sm:mt-[4%] mt-[10px] mx-6 slg:mx-auto  lg:text-[18px] lg:mt-[30px] lg:w-[611px]   font-[400] lg:m-auto  lg:text-center'>
            ...
            <button className='flex justify-center m-auto bg-[#4B2A63]  p-1 w-[25%] sm:mt-[60px] sm:text-[24px] font-[600] sm:w-[270px] sm:h-[80px] sm:p-6 text-white mt-[3%] lg:mt-[42px]'>
                View all
            </button>
