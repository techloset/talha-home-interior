...
const ourProjects = () => {
    return (
        <div className='mt-[10%] lg:bg-[#F5FCFF] sm:mt-[54px]  lg:mt-[57px] font-popinsmedium'>
            ...
            {/* images */}
            <div className=' sm:w-[700px] bg-orange-500 lg:w-auto  slg:w-[960px] grid grid-cols-2 sm:mt-[4%]  mx-auto mt-[8%]  lg:grid lg:grid-cols-12 lg:gap-2 '>
                ...
                {/* text */}
                <div className='col-span-12 slg:w-[90%] slg:mx-auto  bg-green-500 lg:col-span-6   bg-opacity-75  lg:z-10   lg:text-center  lg:p-3 lg:mt-[5%]  lg-w[997px] lg:h-[519px] lg:ml-[-160px]   ' >
                    <div className='bg-yellow-500 lg:w-full lg:m-auto lg:mt-[6%] '>

                        <p className='hidden lg:block  lg:text-[36px] text-[#241330] font-[500] lg:mt-[4%] lg:w-[219px] text-center mx-auto'>Our Projects</p>

                        <p className=' text-center text-[15px] mt-[6%]    lg:text-center lg:ml-[68px]  slg:w-[784px] slg:mx-auto lg:text-[18px] font-[400]  lg:mt-[4%] lg:w-[860px]  bg-blue-500 sm:text-[24px]   sm:h-[180px] sm:text-start'>
