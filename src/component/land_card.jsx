    ...
    return (
        ...
        <div className={combinedClasses}>
            ...
            <div className='md:mt-10'>
                ...
                <div className=' lg:mt-[20px] flex justify-center lg:text-[18px] lg:font-[400] mt-[3px] text-[12px] text-center  w-[80px]  ml-[-22px] sm:text-[18px]  sm:w-[150px] sm:ml-[-47px] md:ml-[0px] sm:mt-[13px]  md:text-center slg:mt-[13px] slg:w-[200px] md:text-[24px] '>{props.text}</div>
