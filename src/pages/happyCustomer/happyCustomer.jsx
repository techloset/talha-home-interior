...
const happyCustomer = () => {
    return (
        <div className='realtive  mt-[10%]  md:grid md:mt-[7%] font-popins'>

            <div class=' mx-5  md:text-center bg-blue-500'>
                <p className=' text-[18px] bg-yellow-500 md:text-[36px] font-[500] md:m-8'>Our Happy Customers</p>
                <p className=' text-[12px] mt-[10px] bg-red-500 md:w-[60%] md:m-auto md:text-[15px] lg:text-[18px] md:font-[400]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam, purus sit amet
                    luctus venenatis, lectus magna fringilla urna, porttitor rhoncus dolor purus non enim</p>
            </div>

            <div className='absolute z-0 md:grid md:grid-cols-12 md:text-center md:mt-[3%]' >
            ...
            <div className='bg-gray-500 realtive z-10 md:bg-white md:w-[50%]  md:mt-[-100px] md:m-auto md:text-center'>

                <img className=' mt-[-20px] bg-red-500  h-[40px] md:h-[78px] md:mt-[-35px] m-auto ' src="/images/happyCustomer4.png" alt="" />
                ...
                <p className=' md:hidden bg-blue-500 w-[75%] mx-auto  text-[10px]  text-center'>Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam, purus sit amet luctus venenatis, 
