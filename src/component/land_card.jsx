    ...
    return (
        ...
        <div className={combinedClasses}>
            ...
            <div className='md:mt-10'>
                ...
                <div className='  flex justify-center mt-[3px] text-[12px] text-center  w-[80px]  ml-[-22px] sm:text-[18px]  sm:w-[150px] sm:ml-[-47px] md:ml-[0px]  md:text-center md:w-[150px] md:text-[24px] '>{props.text}</div>
