        ...
        <div className='mt-[10%]  md:mt-[10%]  font-popins'>
            ...
            <div className='grid grid-cols-12 gap-2 w-[90%] mx-auto mt-[8%]  md:grid md:grid-cols-12 md:gap-2 md:mx-10'>
                ...
                <div className='col-span-6 mx-auto md:col-span-3  '>
                    <img className='w-[250px] mb-[5%] sm:w-[320px] sm:mb-[2%] md:w-[377px] md:h-[309px] lg:h-[300px] md:mb-[5%]   ' src="/images/ourProject1.png" alt="" />
                    <img className='w-[250px] sm:w-[320px]  md:w-[385px] md:h-[194px] ' src="/images/ourProject2.png" alt="" />
                </div>

                <div className='col-span-6 mx-auto  md:col-span-3'>
                    <img className='w-[250px] mb-[5%] sm:w-[320px] sm:mb-[2%] md:w-[385px] md:h-[189px] md:mb-[5%]' src="/images/ourProject3.png" alt="" />
                    <img className='w-[250px] md:w-[378px] sm:w-[320px] md:h-[313px]  lg:h-[300px] ' src="/images/ourProject4.png" alt="" />
                ...
                <div className='col-span-12  md:ml-[-32px] md:col-span-6 md:h-[450px]  bg-white bg-opacity-75  md:z-10  font-popins md:text-center  md:p-3 md:mt-[5%]' >
                    <div className='md:w-full md:m-auto md:mt-[6%]'>
                        ...
                        <p className=' text-[15px] mt-[5%]  md:w-[100%] md:text-center md:m-[5%] md:mt-[7%] md:text-[18px] font-[400]'> 
                    ...
                    <button className='mt-[7%] w-[40%] p-1 flex justify-center mx-auto sm:text-[18px] sm:w-[25%]  bg-[#4B2A63] md:p-3 md:w-[40%] text-white'>View All</button>
                </div>
